...
// export type EndpointMethod = { [key in keyof typeof Endpoint]?: EHttpMethod };
// or
// export type EndpointMethod = Partial<Record<keyof typeof Endpoint, EHttpMethod>>;
// export const EndpointMethods: EndpointMethod = {
//     PLEDGE_LIST: EHttpMethod.GET,
// };

// ALTERNATIVELY:

// Use the Endpoint enum VALUES as keys in the EndpointMethod type.
export type EndpointMethod = { [key in Endpoint]: EHttpMethod };
export const EndpointMethods: EndpointMethod = {
    [Endpoint.EVENT_LIST]:  EHttpMethod.GET,
    [Endpoint.PLEDGE_LIST]: EHttpMethod.GET,
    [Endpoint.TRANSACTION_LIST]: EHttpMethod.GET,
    [Endpoint.TRANSACTION_AFTER]: EHttpMethod.GET,
};
